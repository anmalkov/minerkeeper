...
* Послать нотификацию если ваша ферма не в сети (если произошла потеря электроэнергии, отсоединение от сети Интернет или непредвиденный перезапуск компьютера)
